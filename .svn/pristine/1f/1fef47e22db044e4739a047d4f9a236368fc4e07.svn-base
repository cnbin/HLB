            ...
            <tr>
               <td align="right" style="width: 170px; background-color: #D3E6F4; height: 25px; font-size: 14px;color: #2A5573;" >
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff">
                    ...
                    <input type="hidden" runat="server" value="" id="UserName_Input" />
                                                 <%--&nbsp; &nbsp;--%>
           ...
           <%--<tr>
            <td align="right" style="width: 170px; height: 25px; background-color: #D6E2F3" >
                ...
                <td style="padding-left: 5px; height: 25px; background-color: #ffffff" >
                    ...
                    <asp:Button Text="预警转发" runat="server" ID="ZT2" OnClick="ZT2_Click"/>
                    <asp:Button Text="预警取消" runat="server" ID="ZT3" OnClick="ZT3_Click"/>
                <td >                   
            </tr>--%>
            <tr>
              <td align="right" style="width: 170px; background-color: #D3E6F4; height: 25px; font-size: 14px;color: #2A5573;" >
