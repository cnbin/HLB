...
<SCRIPT LANGUAGE="JavaScript">
    ...
    <script type="text/javascript">
        ...
        function selState() {
            ...
            wName = window.showModalDialog('../Main/SelectCondition.aspx?TableName=ERPLanEmail&LieName=EmailState&Radstr=' + RadNum, '', 'dialogWidth:350px;DialogHeight=400px;status:no;help:no;resizable:yes;');
            if (wName == null)
            { }
            else { document.getElementById('TextBox3').value = wName; }
        }
    </script>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            ...
            <div id="hlb_select" runat="server" class="hlb_select">
            	<ul>
                	<li>主题：</li><li><asp:TextBox ID="TextBox1" runat="server" CssClass="hlb-text"></asp:TextBox>
                        <input type="hidden" id ="tb1_value" value="" runat="server" />
                	            </li>
                    <li>发送人：</li><li><asp:TextBox ID="TextBox2" runat="server" CssClass="hlb-text"></asp:TextBox>
                        <input type="hidden" id ="tb2_value" value="" runat="server" />
                                 </li>
                    <li>状态：</li><li onclick="selState()"><asp:TextBox ID="TextBox3" runat="server" CssClass="hlb-text"></asp:TextBox>
                        <input type="hidden" id ="tb3_value" value="" runat="server" />
                                </li>
        ...
        <div class="hlb-title">
                ...
                <ul>
                  ...
                  <%--  <li><asp:Button  id="btn_Change" runat="server" Cssclass="hlb-iframebtn5"  Text="修改" OnClick="btn_Change_Click" ></asp:Button></li>--%>
                        ...
                        <asp:TemplateField HeaderText="调度主题">
                            <ItemTemplate>
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "EmailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")+"&&iframeid=001"%>'><%# DataBinder.Eval(Container.DataItem, "EmailTitle")%></asp:HyperLink>
                            </ItemTemplate>
                            <ItemStyle HorizontalAlign="Left" />
                        </asp:TemplateField>
                        <asp:BoundField DataField="TrueName" HeaderText="发送人" >                           
                            <ItemStyle Width="110px" />
                        </asp:BoundField>
                        <asp:BoundField DataField="TimeStr" HeaderText="发送时间" >                            
                            <ItemStyle Width="130px" />
                        </asp:BoundField> 
                        <asp:BoundField DataField="EmailState" HeaderText="调度状态" >                            
                            <ItemStyle Width="100px" />
                        </asp:BoundField> 
                    </Columns>
                    <RowStyle HorizontalAlign="Center" Height="25px" />
                <EmptyDataTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="hlbdata-list">
                        <tbody>
                        <tr>
                            <th scope="col">调度主题</th>
                           <th scope="col"  Width="110px">发送人</th>
