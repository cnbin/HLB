        ...
        <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">
         ...
         <tr>
            ...
            <div id="hlb_select" runat="server" class="hlb_select">
            	<ul>
                	<li>详情：</li><li><asp:TextBox ID="TextBox1" runat="server" CssClass="hlb-text"></asp:TextBox>
            ...
            <td>
                <asp:GridView ID="GVData" runat="server" AutoGenerateColumns="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="TypeStr" HeaderText="所属部门"></asp:BoundField>
                        <asp:BoundField DataField="UserName" HeaderText="姓名"></asp:BoundField>
                        <asp:BoundField DataField="TimeStr" HeaderText="分享时间"></asp:BoundField>
                        <asp:BoundField DataField="TitleStr" HeaderText="详情"></asp:BoundField>
                    </Columns>
                    <RowStyle HorizontalAlign="Center" Height="25px" />
                    <EmptyDataTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" width="100%">
                            <tr>
                                 <th scope="col"  Width="100px">所属部门</th>
                                 <th scope="col"  Width="100px">姓名</th>
                                 <th scope="col"  Width="100px">分享时间</th>
                                 <th scope="col"  Width="100px">详情</th>

                            </tr>
                            <tr>
                                <td align="center" colspan="4" style="border-right: black 1px; border-top: black 1px; border-left: black 1px;
