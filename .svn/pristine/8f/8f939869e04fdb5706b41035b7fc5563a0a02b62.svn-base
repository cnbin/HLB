...
namespace ZWL.BLL
{
    ...
    public class ERPFileList
    {
        ...
        private int? _ShiFouTiXing;
        private DateTime? _DaoQiShijian;
        /// <summary>
        /// 
        /// </summary>
        public int ID
        ...
        {
            set { _ShiFouTiXing = value; }
            get { return _ShiFouTiXing; }
        }

        public DateTime? DaoQiShijian
        {
            set { _DaoQiShijian = value; }
            get { return _DaoQiShijian; }
        }
        #endregion Model
        ...
        public ERPFileList(int ID)
        {
            ...
            strSql.Append("select ID,FileName,BianHao,BackInfo,DaXiao,FileType,DirID,ShangChuanTime,FilePath,UserName,IFDel,TypeName,IfShare,DirOrFile,CanAdd,CanMod,CanDel,CanView,DaoQiShijian,ShiFouTiXing ");
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ds.Tables[0].Rows[0]["DaoQiShijian"].ToString() != "")
                {
                    DaoQiShijian = DateTime.Parse(ds.Tables[0].Rows[0]["DaoQiShijian"].ToString());
                }
                if (ds.Tables[0].Rows[0]["ShiFouTiXing"].ToString() != "")
                {
                    ShiFouTiXing = int.Parse(ds.Tables[0].Rows[0]["ShiFouTiXing"].ToString());
                }
            }
        }
        /// <summary>
        ...
        public int Add()
        {
            ...
            strSql.Append("FileName,BianHao,BackInfo,DaXiao,FileType,DirID,ShangChuanTime,FilePath,UserName,IFDel,TypeName,IfShare,DirOrFile,CanAdd,CanMod,CanDel,CanView,DaoQiShijian,ShiFouTiXing)");
            ...
            SqlParameter[] parameters = {
                    ...
                    new SqlParameter("@DaoQiShijian", SqlDbType.DateTime),
                    new SqlParameter("@ShiFouTiXing", SqlDbType.TinyInt,4)};
            ...
            parameters[17].Value = DaoQiShijian;
            parameters[18].Value = ShiFouTiXing;
        ...
        public void Update()
        {
            ...
            strSql.Append("DaoQiShijian=@DaoQiShijian,");
            strSql.Append("ShiFouTiXing=@ShiFouTiXing");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4),
					new SqlParameter("@FileName", SqlDbType.VarChar,50),
            ...
            parameters[18].Value = DaoQiShijian;
            parameters[19].Value = ShiFouTiXing;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 ID,FileName,BianHao,BackInfo,DaXiao,FileType,DirID,ShangChuanTime,FilePath,UserName,IFDel,TypeName,IfShare,DirOrFile,CanAdd,CanMod,CanDel,CanView,DaoQiShijian,ShiFouTiXing ");
            strSql.Append(" FROM ERPFileList ");
            strSql.Append(" where ID=@ID ");
            SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)};
