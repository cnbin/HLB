<%@ Page Language="C#" AutoEventWireup="true" CodeFile="GRXinChou.aspx.cs" Inherits="DocFile_GRXinChou" %>
<html>
	<head>
    ...
    <div>    
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
            <tr>
                ...
                <a class="hei" href="../Main/MyDesk.aspx">桌面</a>&nbsp;>>&nbsp;个人薪酬数据
                </td>
        ...
        <table style="width: 100%">
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
					...
					<asp:TemplateField HeaderText="薪酬管理名称"> <ItemTemplate> <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True" NavigateUrl='<%# "GRXinChouView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")%>'><%# DataBinder.Eval(Container.DataItem, "XCName")%></asp:HyperLink> </ItemTemplate>   <ItemStyle HorizontalAlign="Left" />  </asp:TemplateField> 
