         ...
         <tr>
            ...
            <div id="hlb_select" runat="server" class="hlb_select">
            	<ul>
                    ...
                    <li>发送人：</li><li >
                        <asp:TextBox ID="TextBox2" runat="server" CssClass="hlb-text">
                           </asp:TextBox> <input type="hidden" runat="server" id="tb2_value" value="" /></li>
                    <li>状态：</li><li onclick="selState()">
                        <asp:TextBox ID="TextBox3" runat="server" CssClass="hlb-text"></asp:TextBox>
                        ...
                        <asp:TemplateField HeaderText="调度主题">
                            <ItemTemplate>&nbsp;
                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Underline="True"
                                    NavigateUrl='<%# "EmailView.aspx?ID="+ DataBinder.Eval(Container.DataItem, "ID")+"&&iframeid=098"%>'><%# DataBinder.Eval(Container.DataItem, "EmailTitle")%></asp:HyperLink>
                            </ItemTemplate>
