            ...
            for (var i = 0; i < window.document.form1.elements.length; i++) {
                ...
                if (e.checked) {
                    if (e.title != null) {
                        if (UserName == "") {
                            UserName = e.title;
                            TrueName = e.nextSibling.innerHTML;
                        }
                        else {
                            UserName = UserName + "," + e.title;
                            TrueName = TrueName + "," + e.nextSibling.innerHTML;
                        }
                    }
                }
            }
            return UserName+"|"+TrueName;
        }
...
<body style="text-align: center">
    ...
    <table width="100%" align="left">
        <tr>
            <td align="left">
                <div style=" width: 340px; height: auto; padding-bottom: 3px; padding-top: 0px;
