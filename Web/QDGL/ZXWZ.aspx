<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ZXWZ.aspx.cs" Inherits="QDGL_ZXWZ" %>
     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
          ...
          <div class="hlb-contact">
            ...
            <div id="hlb_select" runat="server" class="hlb_select">
            	<ul>
                	<li>类型：</li><li><asp:TextBox ID="TextBox1" runat="server" CssClass="hlb-text"></asp:TextBox></li>
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                   ...
                   width="100%" border="0" cellspacing="1" cellpadding="1" CssClass="hlbdata-list">
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="CJJGSJ" HeaderText="值">
                        </asp:BoundField>       
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                         <tr>
                            <th scope="col"  Width="100px" >序号</th>
                              <th scope="col"  Width="130px" >值</th>
                              <th scope="col">类型</th>
                             </tr>
                        <tr>
                            <td colspan="3" align="center" style="border-right: black 1px; border-top: black 1px;
