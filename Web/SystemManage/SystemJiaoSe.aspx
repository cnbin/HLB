     ...
     <table style="width: 100%" border="0" cellpadding="0" cellspacing="0">            
          ...
          <div class="hlb-contact">
            ...
            <div id="hlb_select" runat="server" class="hlb_select">
            	<ul>
                	<li>角色名称：</li><li><asp:TextBox ID="TextBox1" runat="server" CssClass="hlb-text"></asp:TextBox><input type="hidden"  runat="server" value=""  id="tb1_value" /></li>
         ...
         <div class="hlb-title">
                ...
                <ul>
                    ...
                    <li><asp:Button  id="btn_Edit" runat="server" Cssclass="hlb-iframebtn5"  Text="修改" OnClick="btn_Edit_Click" ></asp:Button></li>
            ...
            <td ><asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                ...
                <EmptyDataTemplate>
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                        ...
                        <tr>
                            <td colspan="2" align="center" style="border-right: black 1px; border-top: black 1px;
