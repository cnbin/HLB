...
(function () {
    ...
    window.UEDITOR_CONFIG = {
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:"../../net/scrawlUp.ashx"           //涂鸦上传地址
        ,scrawlPath:URL+"net/"                            //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:"../../net/fileUp.ashx"               //附件上传提交地址
        ,filePath:URL + "net/"                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:"../../net/getRemoteImage.ashx"   //处理远程图片抓取的地址
        ...
        //图片在线管理配置区
        , imageManagerUrl:"../../net/imageManager.ashx"       //图片在线管理的处理地址
        ,imageManagerPath:URL + "net/"                                    //图片修正地址，同imagePath

        

        //word转存配置区
        ,wordImageUrl:"../../net/imageUp.ashx"             //word转存提交地址
        ,wordImagePath:URL + "net/"                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        , getMovieUrl: "../../net/getMovie.ashx"                   //视频数据获取地址

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        , toolbars: [
            	['Source', '|', 'PastePlain', '|', 'RemoveFormat', 'FormatMatch', '|', 'Undo', 'Redo', '|',
		 'FontFamily', 'FontSize', 'Bold', 'Italic', 'Underline', 'StrikeThrough', 'Superscript', 'Subscript', 'ForeColor', 'BackColor', '|',
		 'InsertOrderedList', 'InsertUnorderedList', 'Indent', 'JustifyLeft', 'JustifyCenter', 'JustifyRight', 'JustifyJustify', '|',
		 'Link', 'Unlink', '|', 'InsertImage', 'ImageNone', 'ImageLeft', 'ImageRight', 'ImageCenter', '|',
		 'Horizontal', 'Spechars', '|',
		 'InsertTable', 'DeleteTable', 'InsertParagraphBeforeTable', 'InsertRow', 'DeleteRow', 'InsertCol', 'DeleteCol', 'MergeCells', 'MergeRight', 'MergeDown', 'SplittoCells', 'SplittoRows', 'SplittoCols', '|',
		 'SelectAll', 'ClearDoc', '|', 'Group', 'Pageset']
	]
