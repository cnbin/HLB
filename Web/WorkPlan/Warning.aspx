<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Warning.aspx.cs" Inherits="WorkPlan_HuiBaoD" %>
...
<SCRIPT LANGUAGE="JavaScript">
    ...
    function iniWarning(mes) {
        ...
        for (i = 0; i < mes.length; i++) {//遍历json对象的每个key/value对,p为key
            ...
            (function () {
                ...
                //addMarker(p.BZ1, p.BZ2, p.ID, "<div style='line-height:1.8em;font-size:12px;'><b>"
                //    + p.TitleStr + "</b><br>时间:" + p.TimeStr + "</br></div>", p.TitleStr);
            })();
    ...
    function getWarningList() {
        ...
        if (uname == '')
        {
            uname = document.getElementById('TextBox2').value;
        }
        var TitleStr = document.getElementById('TextBox1').value;
        $.ajax({
            type: "Post",
            url: "../WorkPlan/Warning.aspx/GetWarning",
            // data: "{'token':'ajax'}",// 使用这种方式竟然无法传递参数，各位有知道原因的告诉一下啊。
            data: "{'uname':'" + uname + "','TitleStr':'" + TitleStr + "'}",
            dataType: "json",//类型
            ...
            success: function (data) {
                ...
                data.d = [{ "title": "砍伐", "x": x + "", "y": y + "", "TimeStr": "2015-08-08 01:25:51", "id": "14" },
            ...
            <div id="hlb_select" runat="server" class="hlb_select" >
            	<ul>
                	<li>报告主题：</li><li><asp:TextBox ID="TextBox1" runat="server" CssClass="hlb-text"></asp:TextBox>
                        <input type="hidden" id="tb1_value"  runat="server" value="" />
                	              </li>
                    <li>姓名：</li><li><asp:TextBox ID="TextBox2" runat="server" CssClass="hlb-text"></asp:TextBox>
                ...
                <input type="hidden"  id="hidden_input" value="none"  runat="server"/>
                 <input type="hidden"  id="hidden_username" value="none"  runat="server"/>
